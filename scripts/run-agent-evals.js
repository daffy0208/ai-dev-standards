...
program
  ...
  .option('-d, --dataset <path>', 'Path to golden dataset JSON file', 'tests/fixtures/golden-dataset-example.json')
  .option('-m, --mock', 'Use mock agent responses (for testing)', false)
  .option('-o, --output <path>', 'Output path for results JSON', '.validation-history/agent-eval-report.json')
