...
*   *Current PR Score* >= *Main Branch Score* (No Regression).
*   *Latency* <= *Baseline + 10%*.
...
## Summary
This architecture treats "Intelligence" as a managed artifact. By decoupling the *Agent* from the *Judge* and establishing *Baselines*, you can deploy AI with the same confidence as traditional software.
