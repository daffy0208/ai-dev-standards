...
export class LucideClient {
   ...
   */
  async listIcons(options?: { category?: string }): Promise<IconMetadata[]> {
    const metadata = await this.getIconMetadata()
