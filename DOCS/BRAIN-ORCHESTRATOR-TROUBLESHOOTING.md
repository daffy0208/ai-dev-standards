...
Claude: *doesn't know about mvp-builder skill*
You: "Use the mvp-builder skill"
Claude: *reads SKILLS/mvp-builder/SKILL.md*

# With Brain MCP (Automatic):
You: "I need to build an MVP"
Claude: *uses brain_select_skills("build mvp")*
Claude: *discovers mvp-builder skill*
Claude: *reads SKILLS/mvp-builder/SKILL.md*
Claude: *applies methodology*
```
