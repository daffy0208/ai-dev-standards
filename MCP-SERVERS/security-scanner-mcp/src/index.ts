...
async function handleScanDependencies(_args: unknown) {
  if (!config) {
...
async function handleScanSecrets(_args: unknown) {
  if (!config) {
    throw new Error('Scanner not configured. Call configure first.')
  }
...
async function handleScanOwasp(_args: unknown) {
  if (!config) {
    throw new Error('Scanner not configured. Call configure first.')
  }
...
async function handleScanCodePatterns(_args: unknown) {
  if (!config) {
    throw new Error('Scanner not configured. Call configure first.')
  }
...
async function handleGenerateReport(_args: unknown) {
  if (!config) {
    throw new Error('Scanner not configured. Call configure first.')
  }
...
async function handleRiskAssessment(_args: unknown) {
  if (!config) {
    throw new Error('Scanner not configured. Call configure first.')
  }
