...
describe('Embedding Generator MCP Server', () => {
  ...
  describe('Error Handling', () => {
    it('should handle API errors gracefully', async () => {
      const provider = createMockProvider()
      ;(provider.generateEmbeddings as any).mockRejectedValue(new Error('API rate limit exceeded'))

      await expect(provider.generateEmbeddings({ input: 'test' })).rejects.toThrow(
    ...
    it('should handle invalid input gracefully', async () => {
      ...
      await expect(provider.generateEmbeddings({ input: '' })).rejects.toThrow(
    ...
    it('should handle network errors', async () => {
      const provider = createMockProvider()
      ;(provider.generateEmbeddings as any).mockRejectedValue(new Error('Network request failed'))
  ...
  describe('Usage Tracking', () => {
    ...
    it('should track batch token usage', async () => {
      ...
      expect(result.usage.totalTokens).toBeGreaterThanOrEqual(result.embeddings.length)
    })
  })
})
